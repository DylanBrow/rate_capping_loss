...
```{r}
raw_data_tab = read.csv("/Users/stephensegroves/Documents/projects/rate_capping_loss/example/md_raw_data.csv", stringsAsFactors = F)
```
...
```{r}
write.csv(chart4, "/Users/stephensegroves/Documents/projects/rate_capping_loss/example/table_output_test.csv")
```
...
write.csv(output_by_quote_id, "/Users/stephensegroves/Documents/projects/rate_capping_loss/example/output_by_quote_id_test.csv")
```
